    ...
    <div class="row g-4">
      <div class="col-lg-7">
        ...
        <ol class="mb-0">
          ...
          <li class="mb-3"><strong>Oriente os responsáveis a monitorar as WPs existentes.</strong> Cada pessoa configura o token pessoal em <strong>Minhas configurações &gt; OpenProject</strong> e usa <strong>Gerência &gt; Monitoramento de Work Packages</strong>. A consulta é somente de leitura, encontra User Stories, Épicos e Bugs abertos sob sua responsabilidade e gera alertas no sino do cabeçalho. Perfis com acesso à visão gerencial podem consultar o consolidado.</li>
