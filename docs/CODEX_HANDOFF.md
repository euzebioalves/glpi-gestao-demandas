...
Este documento apresenta o estado funcional e técnico da versão `0.17.9` e deve ser usado como contexto inicial por qualquer agente Codex que continue o desenvolvimento.
...
| Plugin Gestão de Demandas | 0.17.9 | `plugins/demandas` |
...
- saldo histórico positivo, negativo e sem saldo-base;
