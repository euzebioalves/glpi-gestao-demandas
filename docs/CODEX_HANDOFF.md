...
Este documento apresenta o estado funcional e técnico da versão `0.18.3` e deve ser usado como contexto inicial por qualquer agente Codex que continue o desenvolvimento.
...
| Plugin Gestão de Demandas | 0.18.3 | `plugins/demandas` |
